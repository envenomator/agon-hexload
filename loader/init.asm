...
user_start:			EQU B7E000h			
max_size:			EQU   2000h		; Max 8KB
;
; Start in ADL mode
;
...
_exec_name:		DB	"HEXLOAD.BIN", 0    					; The executable name, only used in argv
_load_name:		DB	"/MOS/HEXLOAD.DLL", 0					; The loadable module name
...
_start2:
			...
			LD		B, 0				;  C: argc
			JP		user_start			; Start user code - don't return here
...
_error_string:	DB	"Error loading /MOS/HEXLOAD.DLL\r\n",0
